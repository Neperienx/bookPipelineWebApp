...
,
    "seed_prompt": {
        "max_new_tokens": 3024,
        "base": (
            "You are a professional story concept developer. Your task is to take a validated "
            "idea catalyst pitch plus the current character roster and expand them into a fully-"
        ...
        "response_instructions": (
            ...
            "headings, delivers 3–5 premise paragraphs, and honours the supplied pitch and characters. "
        ...
        "instructions": (
            ...
            "1. **Treat the idea catalyst pitch as canon.**  \n"
            "   - Integrate character details exactly as provided.  \n"
            "   - Preserve the tone implied by the pitch without inventing unrelated genre shifts.  \n"
            "   - Do not request extra metadata or clarifications.\n\n"
            "2. **If the pitch omits details, infer them coherently.**  \n"
            "   - Never leave the story empty.  \n"
            "   - Never say “the user did not specify.”  \n"
            "   - Always extrapolate a coherent concept that fits the pitch and characters.\n\n"
            ...
            "   - **Stakes** appropriate to the tone of the pitch\n"
            "   - **Tone & mood** reflected in the story premise\n"
            "   - **Structural expectations** implied by the pitch (pacing, POV, time structure)\n"
            ...
            "6. **Stakes** (scaled to the tone and promise of the pitch; emotional, relational, material, or existential)  \n"
            "7. **Supernatural / Low-Fantasy / Mystery Elements** (only if relevant)  \n"
            "8. **Structural Expectations** (pacing, POV, time structure—based on the pitch)  \n"
